...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            DiceRollerTheme {
                DiceRollerWithImageAndButtonPreview();
            }
        }
    }
}
...
@Composable
fun DiceRollerWithImageAndButton(mod: Modifier = Modifier){
...
//            verticalArrangement = Arrangement.Center
            ...
            Image(painter = imageRes, contentDescription = result.toString());
...
@Preview
@Composable
fun DiceRollerWithImageAndButtonPreview()
{
